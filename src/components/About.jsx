...
const About = () => {
  return (
    <div className="2xl:px-20 mx-auto my-10">
      <div className="flex items-center justify-center gap-7 flex-col lg:flex-row pt-10">
        <div>
      ...
      <div className="flex items-center justify-center gap-7 flex-col-reverse lg:flex-row-reverse pt-15">
        <div>
        ...
        <div className="flex flex-col items-start ">
          ...
          <div>
            ...
            <div className="flex items-start justify-center gap-4 flex-col lg:flex-row py-4">
